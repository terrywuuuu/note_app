    ...
    if (formType === 'register') {
        ...
        formContainer.innerHTML = `
            ...
            <a target="_self" rel="noopener noreferrer">
              <button onclick="loginWithGoogle()" type="button" style="background:#4285F4;color:white;padding:8px 16px;border:none;border-radius:4px;">
            ...
            <a target="_self" rel="noopener noreferrer">
              <button onclick="loginWithGithub()" type="button" style="background:#333;color:white;padding:8px 16px;border:none;border-radius:4px;">
...
function loginWithGoogle() {
    window.location.href = 'https://supernote-l6k9.onrender.com/api/auth/google';
}

function loginWithGithub() {
    window.location.href = 'https://supernote-l6k9.onrender.com/api/auth/github';
}
